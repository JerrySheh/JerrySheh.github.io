...
**计算机基础** |  |  | |
--- | --- | --- | --- 
[句柄（handle）](#句柄-handle) | [文件描述符（fd）](#文件描述符-file-descriptor) | [缺省（default）](#缺省-default) | [进程（Process）](#进程-process)
[线程（Thread）](#线程-thread) | [并发（Concurrence）](#并发-concurrence) | [并行（Parallel）](#并行-parallel) | [base64编码](#base64编码)
[Hex](#hex编码) |  |  | 
**Web开发** |  |  |  |
...
**计算机硬件** |  |  | |
[HDD](#hdd-hard-disk-drive) | [SSD](#ssd-solid-state-drive) | [RAID](#raid-redundant-array-of-independent-disks) | 
**物联网** |  |  | |
...
> 什么是文本数据，什么是二进制数据，请参考 [计算机系统漫游](/computer-system/lbudvq6j/#文本文件和二进制文件)
