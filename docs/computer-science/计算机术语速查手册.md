...
**计算机基础** |  |  | |
--- | --- | --- | --- 
[句柄（handle）](#句柄-handle) | [文件描述符（fd）](#文件描述符-file-descriptor) | [缺省（default）](#缺省-default) | [base64编码](#base64编码)
[Hex编码](#hex编码) |  |  | 
**操作系统** |  |  |  |
| [进程（Process）](#进程-process) | [线程（Thread）](#线程-thread) | [并发（Concurrence）](#并发-concurrence) | [并行（Parallel）](#并行-parallel)
| [虚拟机（VM）](#虚拟机-vm) | [KVM](#kvm) | | 
**Web开发** |  |  |  |
[base64url](#base64url) | [SPA](#spa-single-page-application) | [SEO](#seo-search-engine-optimization) | [SSO](#sso-single-sign-on)
[SOA](#soa-service-oriented-architecture) | [JWT](#jwt-json-web-token) | [SSE](#sse-server-sent-events) | 
**编程** |  |  |  |
[指针（point）](#指针-point) | [协程（coroutine）](#协程-coroutine) | [CAS](#cas-compare-and-swap) | [闭包（closure）](#闭包-closure)
**异步编程** |  |  |  |
[Promise 和 Future](#promise-和-future) | [callback](#callback) | [async/await](#async-await) | [Monad](#monad)
**信息安全** |  |  | |
[DOS](#dos攻击-denial-of-service) | [DDOS](#ddos攻击-distributed-denial-of-service) | [肉鸡](#肉鸡) | [对称/非对称加密](#对称-非对称加密)
**计算机网络** |  |  |  |
[WAN](#wan) | [LAN](#lan) | [VLAN](#vlan) | [MESH](#mesh)
[CDN](#cdn-content-delivery-network-内容分发网络) |  |  | 
**软件工程** |  |  |  |
[IoC](#ioc-inversion-of-control) | [OOP](#oop-object-oriented-program) | [AOP](#aop-aspect-oriented-program) | [DDD](#ddd-domain-driven-design)
[TDD](#tdd-test-driven-design) | [CAP原理](#cap原理) |  | 
**数据库** |  |  | |
[OLTP](#oltp-online-transaction-processing) | [OLAP](#olap-online-analytical-processing) | [HTAP](#htap-hybrid-transaction-analytical-processing) | 
**硬件和存储** |  |  | |
[HDD](#hdd-hard-disk-drive) | [SSD](#ssd-solid-state-drive) | [RAID](#raid-redundant-array-of-independent-disks) | [NVMe](#nvme-non-volatile-memory-express)
**物联网** |  |  | |
[IoT](#iot-internet-of-things) |  |  | 
**人工智能** |  |  | |
[机器学习](#机器学习-machine-learning) | [深度学习](#深度学习-deep-learning) | [NLP](#nlp-natural-language-processing) | [GPT](#gpt-generative-pre-trained-transformer)
[LLM](#llm-large-language-model) | [AIGC](#aigc-artificial-intelligence-generated-content) | [AGI](#agi-artificial-general-intelligence) | [缩放定律](#scaling-law-缩放定律)
[prompt](#prompt) | [RAG](#rag-retrieval-augmented-generation)  | [MCP](#mcp-model-context-protocol)  |
**互联网行业** |  |  | |
[UGC](#ugc-user-generated-content) | [PGC](#pgc-professional-generated-content) | [MCN](#mcn-multi-channel-network) | [ROI](#roi-return-on-investment) |
...
全称是 非易失性内存主机控制器接口规范，是一种专门为现代固态硬盘（SSD）设计的高速数据传输协议。
