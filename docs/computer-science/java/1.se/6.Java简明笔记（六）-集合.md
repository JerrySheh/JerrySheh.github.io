...
tags:
  - Java
abbrlink: f85bb872
createTime: 2018/02/04 22:43:40
permalink: /java/wfyve8c4/
---
...
##### HashMap 哈希冲突时是头插法还是尾插法？

在 jdk 1.7 是头插法，后来发现在多线程环境下扩容时可能会导致死循环，因此在 jdk 1.8 中改成了尾插法，并同时持有头、尾节点的引用来保证插入性能。
...
- lambda的知识可参考 [Lambda表达式](/java/oclibm2w/)
