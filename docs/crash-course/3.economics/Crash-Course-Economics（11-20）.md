...
![美国各阶层收入占比](/images/crashcourseeco/income_inequality.png)

我们可以用基尼指数来衡量收入差距，**基尼指数** 就是 收入分配绝对平等 和 实际分配 的差距大小。指数为0%代表完全平等，100%代表完全不平等。

![基尼指数](/images/crashcourseeco/gini_index.png)
...
![边际收益和边际成本](/images/crashcourseeco/marginal_utility.png)
